...
flags.DEFINE_string("train_record_dir", "./train-tfrecord/", "train tfrecord dataset path")
flags.DEFINE_string("test_record_dir", "./test-tfrecord/", "test tfrecord dataset path")
...
flags.DEFINE_integer("eval_batch_size",1924, "batch size of training")
...
flags.DEFINE_integer("train_steps", 10, "Number of (global) training steps to perform")
...
flags.DEFINE_integer("expert_net_num", 10, "number of expert net")
flags.DEFINE_integer("ple_levels", 2, "level of ple net")
flags.DEFINE_integer("units", 8, "hidden units")
